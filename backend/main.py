...
def generate_pdf_report(
    ...
    story.append(Paragraph("Distill Analysis Report", title_style))
    ...
    story.append(Paragraph(
        "<i>Report generated by Distill</i>",
...
@app.get("/")
async def root():
    return {"message": "Distill API", "status": "running"}
