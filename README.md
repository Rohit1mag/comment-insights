...
- [Together AI API key](https://api.together.xyz/) (for Gemma 4 via Together AI)
...
- **[Together AI](https://www.together.ai/)** - AI analysis (google/gemma-4-31B-it)
...
- [Together AI](https://www.together.ai/) for Gemma 4 access
